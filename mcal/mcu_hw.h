...
#define HWREG32(address)                    (*((volatile uint32 *)(address)))
#define HWREG16(address)                    ((*((volatile uint16 *)(address))))
...
#define CORE_PERIPHERAL_BASE_ADDR           0xE000E000
#define APINT                               HWREG32(CORE_PERIPHERAL_BASE_ADDR + 0xD0C)
#define INTERRUPT_EN0                        HWREG32(CORE_PERIPHERAL_BASE_ADDR + 0x100)

#define INTERRUPT_EN_ADDRESS                (((volatile uint32 *)(CORE_PERIPHERAL_BASE_ADDR+100)))
#define INTERRUPT_PRI_ADDRESS                (((volatile uint32 *)(CORE_PERIPHERAL_BASE_ADDR+400)))
